...
import {Terrain,setActiveLevel,SIZE} from '../src/terrain.js?v=111';
import {Player} from '../src/player.js?v=111';
import {buildHiddenCave,CAVE_X,CAVE_BACK,CAVE_MOUTH,CAVE_WATER,reachedCavePassage} from '../src/hidden-cave.js?v=111';
